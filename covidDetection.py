...
data_list_model2c = listdir('covidDetection/train')
data_list_model2c

DATASET_PATH_model2c  = 'covidDetection/train'
train_dir_model2c =  'covidDetection/train'
test_dir_model2c =  'covidDetection/test'
IMAGE_SIZE    = (150, 150)
